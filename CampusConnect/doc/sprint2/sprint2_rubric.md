...
## Daily Stand-ups (max 10 marks)
  ...
  Daily Stand-ups Total Mark: 3 / 10

  You should have 3 udates where you conducted a standup that everone submitted. It should not be that everyone submitted random standups at their choosing.
...
Tracking on Trello Total Mark: 21 / 24
...
## Sprint Demo (Max 10 marks) 
  ...
  Some of the text is a bit hard to see with the transparent background.
...
## Workload distribution in time (Max 20 marks) 
  ...
  Commits in week one = 12
  Commits in week one = 65

  % of week one commits = 16%
